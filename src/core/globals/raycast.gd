...
func _do_raycast_on_mouse_position(collision_mask: int = 1):
...
func get_mouse_world_position(collision_mask: int = 1):
...
func get_raycast_hit_object(collision_mask: int = 1):
	var raycast_result = _do_raycast_on_mouse_position(collision_mask)
	if raycast_result:
